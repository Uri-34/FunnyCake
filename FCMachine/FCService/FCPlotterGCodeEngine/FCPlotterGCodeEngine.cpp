...
FCPlotterGCodeEngine::FCPlotterGCodeEngine(QObject *parent)
    : FCService("GCodeEngine", parent)
{
}

void FCPlotterGCodeEngine::init(FCGCodeController *controller, FCPumpRamp *ramp)
{
    _controller = controller;
    _ramp = ramp;
}

QStringList FCPlotterGCodeEngine::generate(const FCImageBinaryContainer &container)
{
    QStringList gcode;
